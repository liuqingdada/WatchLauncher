...
public class PersistentCookieStore {
    ...
    public void add(HttpUrl url, Cookie cookie) {
        ...
        prefsWriter.putString(url.host(), TextUtils.join(",", cookies.get(url.host())
                                                                     .keySet()));
    ...
    public List<Cookie> get(HttpUrl url) {
        ...
        if (cookies.containsKey(url.host())) {
            ret.addAll(cookies.get(url.host())
                              .values());
        }
        return ret;
    }
    ...
    public boolean remove(HttpUrl url, Cookie cookie) {
        ...
        if (cookies.containsKey(url.host()) && cookies.get(url.host())
                                                      .containsKey(name)) {
            cookies.get(url.host())
                   .remove(name);
